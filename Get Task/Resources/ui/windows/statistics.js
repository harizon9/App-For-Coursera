...
function loadStatistics(inParam){
	...
	var taskTimeInMinutes = parseInt(statistix.totalTimeForTasks,10);
	...
	var labelHours = Ti.UI.createLabel({text:taskTimeText, color:'#f00', top:'10%', font:{fontSize:28}});
	newWinDisplay.add(labelHours);
	
	var textStatement1 = Ti.Locale.getString('statistics_1') + ' ' + taskTimeText + ' ' + Ti.Locale.getString('statistics_2');
